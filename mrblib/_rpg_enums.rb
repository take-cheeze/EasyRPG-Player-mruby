...
module Passable
  Down = 0x01; Left = 0x02; Right = 0x04; Up = 0x08

  Above = 0x10; Wall = 0x20; Counter = 0x40
end

BLOCK_C =  3000
BLOCK_D =  4000; BLOCK_D_BLOCKS = 12
BLOCK_E =  5000; BLOCK_E_TILES = 144
BLOCK_F = 10000; BLOCK_F_TILES = 144
